...
public partial class Summer2025HandbagDbContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brand__DAD4F3BE58E69F0B");
        ...
        {
            entity.HasKey(e => e.HandbagId).HasName("PK__Handbag__785BD69FDECC519B");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA58693BB5BF4");
